...
<article className='p-4 bg-white rounded-lg'>
    <div class="flex items-center mb-4 space-x-4 mt-4">
        <Image class="w-10 h-10 rounded-full" src="/Testing/HeadPhonesP.webp" alt="" width={30} height={30}/>
    ...
    <p class="mb-2 text-gray-500 line-clamp-6 dark:text-gray-400">This is my third Invicta Pro Diver. They are just fantastic value for money. This one arrived yesterday and the first thing I did was set the time, popped on an identical strap from another Invicta and went in the shower with it to test the waterproofing.... No problems.</p>
